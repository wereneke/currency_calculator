...
import com.codecool.wera.currency_calculator.util.RequestLoggingUtil;

@Component
public class CurrencyRequestInterceptor extends HandlerInterceptorAdapter {

    private final static Logger LOGGER = LoggerFactory.getLogger(CurrencyRequestInterceptor.class);
